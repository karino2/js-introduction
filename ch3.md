...
`var`というのは、実はダンボール箱を作る、という意味なのです。
だから
...
さて、変数、いかがでしたでしょうか？難しい？個人的には名前の難しそうな雰囲気に比べると大した事無い奴だと思っているのですが。
