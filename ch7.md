...
その行のはじめの空欄（普通プログラムでは空白と言いますが）の関数についてどうするか？を、ここで軽く触れておきます。  
...
**JavaScriptの関数は特別難しい**  
もともと関数というもの自体、どのプログラミング言語だろうと難しいものですが、
JavaScriptというプログラミング言語は、数あるプログラミング言語の中でもトップクラスに関数が難しいプログラミング言語だと思います。  
　  
