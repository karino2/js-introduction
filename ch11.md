...
なお、今回紹介する書き方は、書けるようになる必要はありません。
他人のコードでここで紹介した書き方を見かけた時に、本ページを見直して意味が解読出来れば十分です。
そういう訳でちゃんと理解しなくても良くて「なんか見覚えあるな」くらいのレベルでOKです。

という事で課題とかも無しで軽く説明するくらいに留めます。
...
　  
このように`function awa(){`とやると、varをつけた時のように、変数としての箱も出来ます。
...
　  
わけわからん、と思うかもしれませんが、これは決まりなので、これまでの書き方に翻訳して読むしかありません。
...
　  
あまり最初と最後の行は気にしないで、こういう書き方がある、と割り切ってしまうのがオススメです。
