...
最終的にはやっぱりツクールMV以外でプログラムをしてみよう、というのでも良いようにこのシリーズは作ったつもりですが、
それでも最初はツクールMVで使ってみるのがこのシリーズの後としてはスムーズだと思います（特におまけの三回はそれを意図しているので）。

この二つを同時に進める一番良い方法はやはり「実際にゲームを作ってみる」だと思います。

このシリーズをここまでやる時点でも普段の生活の中に結構な時間を取らないと行けなくて、結構な負担だったと思います。
この上さらに明日からゲームを作り始める、というのはなかなか難しいでしょう。

ですが、少し日があいても良いので、実際に作り始めて、「ここを直したい」というのがある程度出てから、
本シリーズをもう一回復習して調べながらいじっていく、というのが理想的な進め方だと思います。
...
この辺わからねーなぁ、と詰まってた時間。
でも復習だと一周目よりは詰まる場所はずっと減っているはずなので、たぶん3～4日くらいで全部読み直せるんじゃないでしょうか。

実際に直したい、と思う事は、残念な事に結構大変な事もあって、中には今の実力では直せない、という事もあるかと思います（これはどこまで行ってもある）。
ただ現時点の実力で直せる事も相当多いはずで、幾つかは実際に直せる物もあるはずです。

そうやって調べながら直していくと、「こういう事を変えたい時はこの辺いじれば良いのか」とだんだんとアタリがつくようになると思います。
また、現在の知識で出来る事と出来ない事の区別もついてくるようになると思います。
そこまで行けば中級者なんじゃないでしょうか。
...
また、プログラム言語を一つちゃんと知っているか知らないかの差は結構大きいと思います。
世の中の大抵のプログラムの解説は、「何か一つ別の言語を知っている」という前提で書かれている物が多いので、
どれか一つを知らないと難しくて読めない。

このシリーズを一通りやれば、最初の一つをちゃんと知った、と言える状態になります。  
そうすれば、JavaScript以外のこれまで手の届かなかった多くの入門解説も分かるようになるはずです。

### このシリーズでやらなかった事

このシリーズでやらなかった事も簡単にまとめておきます。
...
terunonさんの[卑弥呼テクニック](http://ch.nicovideo.jp/terunon/blomaga/ar973025)は、実際にどんな事がどういう感じで出来るのか、という事を知るのに良い記事だと思います。
...
ある程度作業を進めていって理解が進んだら、そのあとは全体的な説明を読んでみると良いと思います。
これは最初にやっても仕方なくて、ある程度やったあとで。
...
このサイトの他にも幾つか同じような趣旨の内部解説のサイトはあるので、自分のいじりたい所に合わせてググって読んでみるのが良いと思います。

ただプログラム入門者は、やはり最初にある程度自分で書いて、経験を積んでから読む方が良いです。
...
網羅的に書かれていて、このサイトで見つからない事は無いといっても過言では無い。
ググった時もMDNのサイトが引っかかっていたらまずそれを読むのがオススメな位質も高いです。

このMDNのサイトは、今回リンクで紹介したガイド以外でも良く書かれています。
チュートリアルの中級編と上級編ではトピック別に詳しい説明があるので、こうした事が気になりだしたらオススメのサイトになります。
