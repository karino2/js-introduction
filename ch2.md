...
　  
これらは、JavaScriptを動かす側が勝手に決める事になっています。動かす側、というのは、ツクールMVとかwebとかUnityとかSecond Lifeとかの事です。  
...
ただ、環境はどれも似ている事が多いので、一つ何かのプラグインの書き方とか覚えてしまえば、他の環境を勉強するのは結構たいした事ありません。  
　   
